...
const app = express();
app.get("https://glitch.com/~azam5555", (request, response) => {
...
client.on("ready", () => {
  ...
  client.user.setActivity(`${prefix}help created by AsKat_azam `, { type: "WATCHING" });
});
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@498030052508696586>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
\`شرح البوت \` : <created by AsKat_azam>
`);
        })
        .then(e => {
          message.react("✅");
